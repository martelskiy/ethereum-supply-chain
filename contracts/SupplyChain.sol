...
import "../abstractions/SupplyChain.sol";
...
contract SupplyChain is ISupplyChain {
    ...
    mapping(uint32 => SupplyChainLib.Product) public products;
    mapping(uint32 => SupplyChainLib.Participant) public participants;
    mapping(uint32 => SupplyChainLib.Ownership) public ownerships;
    ...
    function newOwner(
        ...
        SupplyChainLib.Participant memory p1 = participants[_user1Id];
        SupplyChainLib.Participant memory p2 = participants[_user2Id];
    ...
    function getOwnership(
        ...
        SupplyChainLib.Ownership memory r = ownerships[_regId];
